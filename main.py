...
# Keep Mac awake while this script is running (only on macOS).
# This uses `caffeinate -w <pid>` so the assertion ends when this process ends.
if sys.platform == "darwin":
    try:
        subprocess.Popen(["caffeinate", "-di", "-w", str(os.getpid())])
